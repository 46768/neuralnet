...
FileData *get_file_read(char *filename) { return _get_file(filename, "rb"); }

FileData *get_file_write(char *filename) { return _get_file(filename, "wb"); }
